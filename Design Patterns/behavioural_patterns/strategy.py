...
# Open-closed principle: class is open for extension and closed for modification

# A common alternative to this pattern is to simply pass in an inline / lambda function, which allows us 
# to extend the behaviour of a method or class
